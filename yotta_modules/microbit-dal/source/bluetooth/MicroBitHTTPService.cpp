...
MicroBitHTTPService::MicroBitHTTPService(BLEDevice &_ble) : ble(_ble) {
  GattCharacteristic urlCharacteristic(MicroBitHTTPServiceUrlUUID, (uint8_t*)&urlCharacteristicBuffer, 1, 20, GattCharacteristic::BLE_GATT_CHAR_PROPERTIES_READ | GattCharacteristic::BLE_GATT_CHAR_PROPERTIES_WRITE);
